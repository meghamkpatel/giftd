...
export default class Parent extends Component {
  ...
  render() {
    ...
    return (
      <ScrollView style={styles.container} contentContainerStyle= {{justifyContent: "center"}} centerContent = {true}>
        ...
        />
          <Text> </Text>
          <Text style={styles.info}> What kind of food does {this.props.answers.who || "Parent"} like? </Text>
          <MultiSelect
            style={{ flex: 1 }}
          ...
          <TextInput
            ...
            value={this.props.setAnswers.hobbies}
          />
          <Text> </Text>
          <TextInput
            style={styles.input}
            placeholder= "What's your favorite memory with them?"
            onChangeText={text => this.props.setAnswers({ memories: text })}
            value={this.props.setAnswers.memories}
          />
          <Text> </Text>
          <TextInput
            style={styles.input}
            ...
            value={this.props.setAnswers.age}
          />
          <Text> </Text>
