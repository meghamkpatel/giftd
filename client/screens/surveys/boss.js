    ...
    return (
      <ScrollView style={styles.container} contentContainerStyle= {{justifyContent: "center"}}>
        ...
        <View >
          ...
          />
          <Text> </Text>
          <Text style={styles.info}> What kind of food does {this.props.answers.who || "Boss"} like? </Text>
          <MultiSelect
            style={{ flex: 1 }}
            items={sortedCuisines}
            uniqueKey="name"
            onSelectedItemsChange={this.onSelectedCuisine}
            selectedItems={this.props.annswers.food}
          ...
          <Text style={styles.info}> What gender is your boss? </Text>
          <RadioForm
