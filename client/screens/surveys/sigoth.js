...
export default class SignificantOther extends Component {
    ...
    return (
      <ScrollView style={styles.container} contentContainerStyle= {{justifyContent: "center"}}>
        ...
        <View >
          ...
          />
          <Text> </Text>
          <Text style={styles.info}> What kind of food does {this.props.answers.who || "Significant Other"} like? </Text>
          <MultiSelect
            style={{ flex: 1 }}
